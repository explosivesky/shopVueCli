...
<template>
	<div class="bg-white px-4 position-absolute pt-2" style="top: 55px; right: 0; bottom: 0; left: 0;">
			...
			<template #right>
				<div class="flex align-center">
					<el-date-picker
						...
						<el-input v-model="search.keyWord" placeholder="请输入订单号" class="mx-2" style="width: 150px;" size="medium"></el-input>
		...
		<el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" height="700" border style="width: 100%" class="mt-2 pb-1" @selection-change="handleSelectionChange">
			...
			<el-table-column label="商品信息" prop="order" show-overflow-tooltip></el-table-column>
			<el-table-column label="商品清单" align="center" prop="username" show-overflow-tooltip></el-table-column>
			<el-table-column label="订单金额" align="center" prop="price" show-overflow-tooltip></el-table-column>
			<el-table-column label="收货信息" align="center" prop="price" show-overflow-tooltip></el-table-column>
			<el-table-column label="买家" align="center" prop="value" show-overflow-tooltip></el-table-column>
			<el-table-column label="交易状态" align="center" prop="code" show-overflow-tooltip></el-table-column>
